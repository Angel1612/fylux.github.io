...
$$
\int \int_{T} f(x(u,v),y(u,v)) \left|\frac{d(x,y)}{d(u,v)}\right|\,du\,dv
$$
...
<br/>
## Acknowledgement
I want to thank Dr. F. Guil Asensio and Dr. G.M. Diaz-Toca their support for understanding the concepts covered in this article, a computer scientist like me couldn't have ever understand it without their help. 
