...
---
## Introduction
If you have worked with graphs you've probably made use of an <a href="https://en.wikipedia.org/wiki/Adjacency_matrix">adjacency matrix</a>. But if your graph is undirected, you can notice that the element `[i][j] = [j][i]`. Something similar happens when doing DFA Minimization. Unfortunately, this way we are "wasting" half of the memory and it doesn't sound good.
